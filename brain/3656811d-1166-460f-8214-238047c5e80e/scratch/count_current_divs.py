...
print(f"Current page.tsx total lines: {len(lines)}")
...
count_tags("Prefix", 1, 897)
count_tags("Practice Terminal (898 to 1278)", 898, 1278)
count_tags("Suffix", 1279, len(lines))
