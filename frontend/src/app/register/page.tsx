      ...
      <div className="relative w-full max-w-md p-[1px] rounded-2xl bg-gradient-to-b from-zinc-800 to-transparent shadow-2xl z-10 anim-scalein">
        <div className="w-full bg-zinc-900/80 backdrop-blur-2xl border border-zinc-800/60 rounded-[15px] p-8 space-y-6">
          <div className="text-center space-y-3">
            ...
            <div>
              <CardTitle className="text-2xl font-bold tracking-tight text-zinc-100">Create Your Account</CardTitle>
          ...
          <div className="p-0 space-y-5">
            ...
            {successMsg && (
              <div className="p-3.5 bg-emerald-950/40 border border-emerald-900/50 rounded-xl text-xs font-semibold text-emerald-400 anim-fadeup">
                {successMsg}
              </div>
            )}
            ...
            <div className="text-center text-xs text-zinc-400">
              ...
              <Link href="/login" className="text-blue-400 hover:text-blue-300 hover:underline font-semibold transition-all ml-1">
                Log in
              </Link>
            </div>
          </div>
