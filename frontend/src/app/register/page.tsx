      ...
      <div className="relative w-full max-w-md p-[1px] rounded-2xl bg-gradient-to-br from-[#fbbf24]/30 via-[rgba(21,46,27,0.15)] to-[#fb7185]/30 shadow-2xl z-10">
        <Card className="w-full bg-white/45 backdrop-blur-xl border border-[rgba(86,135,100,0.18)] rounded-[15px] p-6 space-y-6">
          <CardHeader className="text-center space-y-3 p-0 pt-2">
            ...
            <div>
              <CardTitle className="text-2xl font-black tracking-tight text-[#112615]">Create Your Account</CardTitle>
              <CardDescription className="text-xs text-[#2d5a37]/80 mt-1.5 font-semibold tracking-wide leading-relaxed uppercase">
          ...
          <CardContent className="p-0 space-y-6">
            ...
            {successMsg && (
              <div className="p-3 bg-emerald-50/70 border border-emerald-200 rounded-lg text-xs font-semibold text-emerald-700">
                {successMsg}
              </div>
            )}
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="name" className="text-[10px] text-[#2d5a37]/80 font-extrabold uppercase tracking-wider">
                  Full Name
                </Label>
                <Input
                  id="name"
            ...
            <div className="text-center text-xs text-[#2d5a37]/75">
              ...
              <Link href="/login" className="text-[#fb7185] hover:underline font-bold transition-all ml-1">
                Log in
              </Link>
            </div>
          </CardContent>
